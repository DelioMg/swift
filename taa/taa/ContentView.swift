...
struct ContentView: View {
            ...
            VStack  {
                HStack {
                    ...
                    HStack {
                        ...
                        Button("Automático") { automatico() }
                            .font(.title)
                            .buttonStyle(BorderlessButtonStyle())
                            .padding()
                            .foregroundColor(.white)
                        Button("Configurações") { showExplore.toggle() }
                            .font(.title)
                            .buttonStyle(BorderlessButtonStyle())
                            .foregroundColor(.white)
                            .padding()
                ...
                HStack{
                    ...
                    Divider()
                        .frame(height: 170)  // Altura da divisória
                        .padding(.horizontal)
    ...
    private func automatico() {
        // Adicione aqui a lógica para o controle automático
        print("Controle automático ativado")
    }
